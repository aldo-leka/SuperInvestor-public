...
namespace SuperInvestor.Migrations
{
    ...
    [Migration("20250522120318_ChangeSubscriptionModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SuperInvestor.Features.Subscription.Data.UserSubscription", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<DateTime?>("LastPaymentFailure")
                        .HasColumnType("timestamp with time zone");

                    b.Property<bool>("PastDue")
                        .HasColumnType("boolean");

                    b.Property<int?>("PaymentFailedCount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SuperInvestor.Features.Subscription.Data.UserSubscription", b =>
                {
                    b.HasOne("SuperInvestor.Features.Identity.Data.ApplicationUser", "User")
                        ...
                        .HasForeignKey("SuperInvestor.Features.Subscription.Data.UserSubscription", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
